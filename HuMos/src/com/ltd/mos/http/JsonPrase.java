...
public class JsonPrase {
	 ...
	 * @return
	 */
	public ArrayList<PostBean> getXunjiuList(String json) {
				...
				if (tagName.equals("resultList")
					...
					while (reader.hasNext()) {
						...
						while (reader.hasNext()) {
							...
							if (tName.equals("story")
									&& reader.peek() != JsonToken.NULL) {
								postBean.setXunJiuContent(reader.nextString());
							} else if (tName.equals("custRequestId")
									&& reader.peek() != JsonToken.NULL) {
								postBean.setXunJiuId(reader.nextString());
							} else if (tName.equals("custRequestName")
									&& reader.peek() != JsonToken.NULL) {

								postBean.setXunJiuTitle(reader.nextString());
							} else if (tName.equals("createdDate")
									&& reader.peek() != JsonToken.NULL) {
								postBean.setXunJiuCreatDate(reader.nextString());

							} else if (tName.equals("contentId")
									&& reader.peek() != JsonToken.NULL) {
							...
							postBean.setXunJiuImages(strList);
						}
	 ...
	 * @return
	 */
	public LeisureBean getheadthDrink(String str) {
		...
		try {
			...
			while (reader.hasNext()) {
				String tagName = reader.nextName();
				if (tagName.equals("healthDrinkList")
						&& reader.peek() != JsonToken.NULL) {
					reader.beginArray();
					while (reader.hasNext()) {
						reader.beginObject();
						while (reader.hasNext()) {
							...
							if (tName.equals("noteName")
									&& reader.peek() != JsonToken.NULL) {
								leisureBean.setNoteName(reader.nextString());
							} else if (tName.equals("noteInfo")
									&& reader.peek() != JsonToken.NULL) {
								leisureBean.setNoteInfo(reader.nextString());
							} else if (tName.equals("noteDateTime")
									&& reader.peek() != JsonToken.NULL) {
								leisureBean.setNoteDateTime(reader.nextString());
							} else {
								reader.skipValue();
							}
						}
	 ...
	 * @return
	 */
	public LeisureBean getwineDrink(String str) {
		LeisureBean leisureBean = new LeisureBean();
		JsonReader reader = new JsonReader(new StringReader(str));
		try {
			reader.beginObject();
			while (reader.hasNext()) {
				String tagName = reader.nextName();
				if (tagName.equals("wineJokeList")
						&& reader.peek() != JsonToken.NULL) {
					reader.beginArray();
					while (reader.hasNext()) {
						reader.beginObject();
